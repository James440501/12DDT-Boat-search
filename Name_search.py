...
def get_name(*args):
    ...
    result = df[df["Name"].isin([name.get()])]#searching for keyword in .csv file
...
name_selected = Label(text = "Please enter the name of the vessel", pady = 10, bg = "Light Grey", fg = "Blue2", font=("Arial", 20, "bold"))
